class DepartmentsController < ApplicationController
  ...
  def create
    ...
    if @department.save
      if is_dept_and_group_null?(current_user.id , @department.college_id)
        ...
        UserCollege.update_all(["department_id = ?, dept_priv = 4", @department.id], ["user_id = ? and college_id = ? and department_id is null and group_id is null", current_user.id, @department.college_id])
      end 
