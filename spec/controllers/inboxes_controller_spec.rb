...
describe InboxesController do
  ...
  describe "GET index" do
    it "assigns all inboxes as @inboxes" do
      ...
      assigns(:inboxes).should eq([inbox])
    end
  end
  ...
  describe "GET new" do
    it "assigns a new inbox as @inbox" do
      ...
      assigns(:inbox).should be_a_new(Inbox)
    end
  end
  ...
  describe "POST create" do
    describe "with valid params" do
      ...
      it "assigns a newly created inbox as @inbox" do
        post :create, {:inbox => valid_attributes}, valid_session
        assigns(:inbox).should be_a(Inbox)
        assigns(:inbox).should be_persisted
      end

      it "redirects to the created inbox" do
        post :create, {:inbox => valid_attributes}, valid_session
        response.should redirect_to(Inbox.last)
      end
    end
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved inbox as @inbox" do
        ...
        Inbox.any_instance.stub(:save).and_return(false)
        post :create, {:inbox => {}}, valid_session
        assigns(:inbox).should be_a_new(Inbox)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested inbox" do
        inbox = Inbox.create! valid_attributes
        # Assuming there are no other inboxes in the database, this
        # specifies that the Inbox created on the previous line
        # receives the :update_attributes message with whatever params are
        # submitted in the request.
        Inbox.any_instance.should_receive(:update_attributes).with({'these' => 'params'})
        put :update, {:id => inbox.to_param, :inbox => {'these' => 'params'}}, valid_session
      end
      ...
      it "redirects to the inbox" do
        inbox = Inbox.create! valid_attributes
        put :update, {:id => inbox.to_param, :inbox => valid_attributes}, valid_session
        response.should redirect_to(inbox)
      end
    end
    ...
    describe "with invalid params" do
      it "assigns the inbox as @inbox" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Inbox.any_instance.stub(:save).and_return(false)
        put :update, {:id => inbox.to_param, :inbox => {}}, valid_session
        assigns(:inbox).should eq(inbox)
      end
